class HashMap:
    ...
    def add(self, key, value):
        ...
        if key not in self.keys_order:
            ...
            # Optional: Move reinserted keys to end if order should reflect last write
    ...
    def to_builtin_list(self):
        ...
        return [(key, self.get(key)) for key in self.keys_order if self.get(key) is not None]
...
class MonoidHashMap(HashMap):
    """Monoid implementation supporting empty identity and associative concatenation."""
